...
var (
	// VetMainNetParams defines the network parameters for the main Litecoin network.
	VetMainNetParams = chaincfg.Params{
		Name:        "mainnet",
		Net:         VetMainNet,
		DefaultPort: "9333",
		...
		HDPrivateKeyID: [4]byte{0x01, 0x9d, 0xad, 0xe4}, // starts with xprv
...
const (
	...
	VetMainNet wire.BitcoinNet = 0xdbb6c0fc
